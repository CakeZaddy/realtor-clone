...
export default function ForgotPassword() {
  ...
  return (
    ...
    '
      ...
      <div className='flex justify-center flex-wrap items-center pe-6 py-12 max-w-6xl mx-auto'>
        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form className=''>
            <input
              className='mb-6 w-full px-4 py-2 text-xl text-gray-600 bg-white border-gray-300 rounded transition ease-in-out'
              type='email'
              id='email'
              value={email}
              onChange={onChange}
            ...
            <div className='flex justify-between whitespace-nowrap text-sm sm:text-lg'>
              ...
              <p>
                <Link
                  to='/sign-in'
                  className='blue-red-600 blue:text-red-800 transition duration-200 ease-in-out'
                >
                  Sign In
                </Link>
              </p>
